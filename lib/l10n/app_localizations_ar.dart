...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get importHint =>
      'اختر نسخة احتياطية .zip (أو .json أقدم) تم تصديرها من AcademiaApp. سيؤدي ذلك إلى استبدال بياناتك الحالية بما فيها الوسائط.';
  ...
  @override
  String get aboutGymmane => 'حول AcademiaApp';
  ...
  @override
  String get planFailed => 'هذا الملف ليس روتينًا يمكن لـ AcademiaApp قراءته';
  ...
  @override
  String get aiIntro =>
      'لا يتواصل AcademiaApp مباشرةً مع أي ذكاء اصطناعي. تصدّر قائمة تمارينك وتلصقها في المساعد الذي تستخدمه ثم تستورد رده. لا شيء يغادر هاتفك تلقائيًا.';
  ...
  @override
  String get awardFirstStepLine => 'مرحبًا بك في AcademiaApp. هذه هدية لك.';
  ...
  String shareMessage(String name) {
    return '$name — افتح الملف باستخدام AcademiaApp لإضافته.';
  }
  ...
  @override
  String get nothingToImport => 'لا يوجد هنا ما يمكن لـ AcademiaApp استيراده';

  @override
  String get aiStepCopy => 'انسخ الطلب. يحتوي على قائمة تمارينك والتنسيق الذي يقرؤه AcademiaApp.';
  ...
  String get shareIntroBody =>
      'أرسله إلى شريكك أو صديق أو عائلتك. سيصلهم ملف صغير يُفتح في AcademiaApp ويضيف الروتين بلمسة واحدة، مع مجموعاته وأوزانه.';
