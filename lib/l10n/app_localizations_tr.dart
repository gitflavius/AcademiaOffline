...
class AppLocalizationsTr extends AppLocalizations {
  ...
  String get importHint =>
      'AcademiaApp\'den dışa aktarılmış bir .zip (veya eski .json) yedeği seç. Mevcut verilerin, medya dahil, değiştirilecek.';
  ...
  @override
  String get aboutGymmane => 'AcademiaApp hakkında';
  ...
  @override
  String get planFailed => 'Bu dosya AcademiaApp\'in okuyabileceği bir program değil';
  ...
  @override
  String get aiIntro =>
      'AcademiaApp hiçbir zaman doğrudan bir yapay zekâyla iletişim kurmaz. Egzersiz listesini dışa aktarır, kullandığın asistana yapıştırır ve yanıtını yeniden içe aktarırsın. Hiçbir şey kendiliğinden telefondan çıkmaz.';
  ...
  @override
  String get awardFirstStepLine => 'AcademiaApp\'e hoş geldin. Bu bizden.';
  ...
  String shareMessage(String name) {
    return '$name — eklemek için dosyayı AcademiaApp ile aç.';
  }
  ...
  String get importPasteHint =>
      'Buraya bir rutin yapıştır: AcademiaApp\'den paylaşılan, bir yapay zekâ yanıtı, JSON veya CSV.';
  ...
  @override
  String get nothingToImport => 'Burada AcademiaApp\'in içe aktarabileceği bir şey yok';

  @override
  String get aiStepCopy => 'İsteği kopyala. Egzersiz listeni ve AcademiaApp\'in okuduğu biçimi içerir.';
  ...
  String get shareIntroBody =>
      'Partnerine, bir arkadaşına ya da ailene gönder. AcademiaApp ile açılan küçük bir dosya alırlar; setleri ve ağırlıklarıyla tek dokunuşta eklenir.';
