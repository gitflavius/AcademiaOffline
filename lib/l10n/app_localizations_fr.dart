...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get importHint =>
      'Choisis une sauvegarde .zip (ou un ancien .json) exportée depuis AcademiaApp. Cela remplace tes données actuelles, médias compris.';
  ...
  @override
  String get aboutGymmane => 'À propos de AcademiaApp';
  ...
  @override
  String get planFailed => 'Ce fichier n’est pas un programme que AcademiaApp peut lire';
  ...
  @override
  String get aiIntro =>
      'AcademiaApp ne communique jamais directement avec une IA. Tu exportes ta liste d’exercices, tu la colles dans l’assistant que tu utilises déjà, puis tu réimportes sa réponse. Rien ne quitte le téléphone tout seul.';
  ...
  @override
  String get awardFirstStepLine => 'Bienvenue sur AcademiaApp. Celle-ci est offerte.';
  ...
  String shareMessage(String name) {
    return '$name — ouvre le fichier avec AcademiaApp pour l\'ajouter.';
  }
  ...
  String get importPasteHint =>
      'Colle une routine ici : partagée depuis AcademiaApp, une réponse d\'IA, du JSON ou du CSV.';
  ...
  @override
  String get nothingToImport => 'Rien à importer ici pour AcademiaApp';

  @override
  String get aiStepCopy =>
      'Copie la demande. Elle contient ta liste d\'exercices et le format que AcademiaApp lit.';
  ...
  String get shareIntroBody =>
      'Envoie-la à ton ou ta partenaire, à un ami ou à ta famille. Ils reçoivent un petit fichier qui s\'ouvre avec AcademiaApp et l\'ajoute en un geste, avec ses séries et ses poids.';
