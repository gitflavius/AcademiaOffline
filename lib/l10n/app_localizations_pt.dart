...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get importHint =>
      'Escolha um backup .json exportado do AcademiaApp. Isso substituirá seus dados atuais.';
  ...
  @override
  String get aiIntro =>
      'O AcademiaApp não fala com nenhuma IA. Tu tiras a tua lista de exercícios, colas no assistente que já usas e trazes a resposta de volta. Do telemóvel não sai nada sozinho.';
  ...
  @override
  String get awardFirstStepLine => 'Bem-vindo ao AcademiaApp. Esta é por conta da casa.';
  ...
  String shareMessage(String name) {
    return '$name — abra o arquivo com o AcademiaApp para adicionar.';
  }
  ...
  String get importPasteHint =>
      'Cole aqui uma rotina: uma compartilhada do AcademiaApp, a resposta de uma IA, JSON ou CSV.';
  ...
  String get shareIntroBody =>
      'Envie para seu par, um amigo ou sua família. Eles recebem um arquivo pequeno que abre no AcademiaApp e adiciona a rotina com um toque, com séries e pesos.';
