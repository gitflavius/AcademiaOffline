...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get importHint =>
      'Обери резервну копію .zip (або старий .json), експортовану з AcademiaApp. Поточні дані, включно з медіа, буде замінено.';
  ...
  @override
  String get aboutGymmane => 'Про AcademiaApp';
  ...
  @override
  String get planFailed => 'Цей файл не є програмою, яку AcademiaApp може прочитати';
  ...
  @override
  String get aiIntro =>
      'AcademiaApp ніколи напряму не зв’язується зі ШІ. Ти експортуєш список вправ, вставляєш його в асистент, яким уже користуєшся, а потім імпортуєш відповідь. Нічого саме не залишає телефон.';
  ...
  @override
  String get awardFirstStepLine => 'Ласкаво просимо до AcademiaApp. Ця нагорода — подарунок.';
  ...
  String shareMessage(String name) {
    return '$name — відкрийте файл у AcademiaApp, щоб додати.';
  }
  ...
  @override
  String get importPasteHint => 'Вставте програму сюди: поширену з AcademiaApp, відповідь ШІ, JSON або CSV.';
  ...
  @override
  String get nothingToImport => 'Тут немає нічого, що AcademiaApp може імпортувати';

  @override
  String get aiStepCopy => 'Скопіюйте запит. У ньому ваш список вправ і формат, який читає AcademiaApp.';
  ...
  String get shareIntroBody =>
      'Надішліть її партнеру, другу чи родині. Вони отримають невеликий файл, який відкривається в AcademiaApp і додає програму одним дотиком, разом із підходами та вагами.';
